...
UNWANTED_RELEASE.update({
    '_part1', '_part2', '_part3', '_2017', '_cleaned', '_error', '_vb-2017', '_parsed', '_bcrypt', '_vB', '_md5', '_emailpass',
    '[NOHASH]', '[HASH]', 'notfound', 'decrypted', '_notfound', 'nohash', '_dump', 'dump', '.sql', '2018', '2019',
